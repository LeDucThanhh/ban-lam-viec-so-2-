...
const defaultLinks = [
  { name: "Bộ Xây dựng", url: "https://Motcuabxd.moc.gov.vn", icon: "🏗️", category: "TW", order: 0 },
  { name: "Bộ Công Thương", url: "https://Motcua-tthc.moit.gov.vn", icon: "🏭", category: "TW", order: 1 },
  { name: "Bộ Nông nghiệp & MT", url: "https://motcuannmt.mae.gov.vn", icon: "🌾", category: "TW", order: 2 },
  { name: "Bộ Nội vụ", url: "https://motcua.moha.gov.vn", icon: "🏛️", category: "TW", order: 3 },
  { name: "Bộ Y tế", url: "https://motcua.moh.gov.vn", icon: "🏥", category: "TW", order: 4 },
  { name: "Bộ Giáo dục & Đào tạo", url: "https://motcua.moet.gov.vn", icon: "🎓", category: "TW", order: 5 },
  { name: "Bộ Khoa học & Công nghệ", url: "https://motcua.mst.gov.vn", icon: "🔬", category: "TW", order: 6 },
  { name: "Bộ Tư pháp", url: "https://motcua.moj.gov.vn", icon: "⚖️", category: "TW", order: 7 },
  { name: "Bộ Dân tộc và Tôn giáo", url: "https://gqtthc.bdttg.gov.vn", icon: "🤝", category: "TW", order: 8 },
  { name: "Bộ Văn hóa, TT & DL", url: "https://dichvucong.bvhttdl.gov.vn/tiepnhan", icon: "🎨", category: "TW", order: 9 },
  { name: "CSDL Người khuyết tật", url: "https://nguoikhuyettat.moh.gov.vn/", icon: "♿", category: "TW", order: 10 },
  { name: "HT Quản lý Hộ tịch", url: "https://hotichdientu.moj.gov.vn/pages/home", icon: "📝", category: "TW", order: 11 },
  { name: "HT Điều phối giải quyết TTHC", url: "https://quantricong.dichvucong.gov.vn/", icon: "🎛️", category: "TW", order: 12 },
  { name: "HT Quản trị thanh toán tập trung", url: "https://quantrithanhtoan.ndc.gov.vn/", icon: "💳", category: "TW", order: 13 }
];
